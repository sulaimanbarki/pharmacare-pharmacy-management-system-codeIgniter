    ...
    <div class="panel panel-bd">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input type="email" placeholder="<?php echo display('email') ?>" title="<?php echo display('email') ?>" required="" value="admin@admin.com" name="username" id="username" class="form-control">
            ...
            <div class="form-group">
                ...
                <input type="password" title="Please enter your password" placeholder="<?php echo display('password') ?>" required="" value="password" name="password" id="password" class="form-control">
